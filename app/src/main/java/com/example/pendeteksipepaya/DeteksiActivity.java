...
import com.example.pendeteksipepaya.ml.Modelvgg16pepaya;
...
public class DeteksiActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image) {
        try {
            Modelvgg16pepaya model = Modelvgg16pepaya.newInstance(getApplicationContext());
            ...
            Modelvgg16pepaya.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"matang", "mentah", "setengah matang"};
